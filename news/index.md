...
- [`dots_to_estimate()`](https://yardstick.tidymodels.org/reference/developer-helpers.md),
  [`metric_summarizer()`](https://yardstick.tidymodels.org/reference/metric_summarizer.md),
  and
...
- [`mse()`](https://yardstick.tidymodels.org/reference/mse.md) computes
...
- Fixed a small mistake in
  [`ccc()`](https://yardstick.tidymodels.org/reference/ccc.md) where the
  unbiased covariance wasn’t being used when `bias = FALSE`.
...
- New [`msd()`](https://yardstick.tidymodels.org/reference/msd.md) for
  computing the mean signed deviation (also called mean signed
...
- The [`kap()`](https://yardstick.tidymodels.org/reference/kap.md)
...
- When [`sens()`](https://yardstick.tidymodels.org/reference/sens.md) is
...
- Adds
  ...
  [`specificity()`](https://yardstick.tidymodels.org/reference/spec.md)
  as *aliases* for
  [`sens()`](https://yardstick.tidymodels.org/reference/sens.md) and
...
- [`iic()`](https://yardstick.tidymodels.org/reference/iic.md) is a new
  numeric metric for computing the index of ideality of correlation. It
  can be seen as a potential alternative to the traditional correlation
  coefficient, and has been used in QSAR models
...
- [`average_precision()`](https://yardstick.tidymodels.org/reference/average_precision.md)
  ...
  [`pr_auc()`](https://yardstick.tidymodels.org/reference/pr_auc.md). It
  has the benefit of avoiding any issues of ambiguity in the case where
  `recall == 0` and the current number of false positives is `0`.
...
- [`pr_curve()`](https://yardstick.tidymodels.org/reference/pr_curve.md)
  ...
  [`pr_auc()`](https://yardstick.tidymodels.org/reference/pr_auc.md) to
  compute the correct AUC.
...
- Binary [`mcc()`](https://yardstick.tidymodels.org/reference/mcc.md)
  now avoids integer overflow when the confusion matrix elements are
  large ([\#108](https://github.com/tidymodels/yardstick/issues/108)).
...
- [`mase()`](https://yardstick.tidymodels.org/reference/mase.md) is a
  numeric metric for the mean absolute scaled error. It is generally
...
- [`huber_loss()`](https://yardstick.tidymodels.org/reference/huber_loss.md)
  ...
  [`rmse()`](https://yardstick.tidymodels.org/reference/rmse.md), but is
  more sensitive than
  [`mae()`](https://yardstick.tidymodels.org/reference/mae.md) for small
  errors ([@blairj09](https://github.com/blairj09),
...
- [`smape()`](https://yardstick.tidymodels.org/reference/smape.md) is a
  numeric metric that is based on percentage errors
...
- [`f_meas()`](https://yardstick.tidymodels.org/reference/f_meas.md)
  ...
  [`precision()`](https://yardstick.tidymodels.org/reference/precision.md)
  and [`recall()`](https://yardstick.tidymodels.org/reference/recall.md)
...
- Multiclass support has been added for each classification metric. The
  ...
  [`vignette("multiclass", "yardstick")`](https://yardstick.tidymodels.org/articles/multiclass.md).
...
- [`kap()`](https://yardstick.tidymodels.org/reference/kap.md) is a
  metric similar to
...
- A vignette describing the three classes of metrics used in yardstick
  ...
  [`vignette("metric-types", "yardstick")`](https://yardstick.tidymodels.org/articles/metric-types.md).
