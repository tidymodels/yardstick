...
#'
#' \tabular{rcc}{ \tab Predicted \tab \cr Reference \tab Event \tab No Event
#' \cr Event \tab A \tab C \cr No Event \tab B \tab D \cr }
#'
...
#'  true class results should be in the rows of the table.
