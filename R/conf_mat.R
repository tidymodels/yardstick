...
#' @param data A data frame or a [base::table()]. The table should have the
#'  predicted values in columns and the true values in rows.
#' @param dnn A character vector of dimnames for the table. The first is the
#'  name for the reference value (i.e. the known results) and the second is
#'  the predicted value.
