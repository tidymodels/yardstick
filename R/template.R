...
#' `prob_metric_summarizer()`, `dynamic_survival_metric_summarizer()`, and
#' `static_survival_metric_summarizer()`. are useful alongside [check_metric]
...
#' `numeric_metric_summarizer()`, `class_metric_summarizer()`,
#' `prob_metric_summarizer()`, `dynamic_survival_metric_summarizer()`, and
#' `static_survival_metric_summarizer()`. are generally called from the data
...
#' `numeric_metric_summarizer()`, `class_metric_summarizer()`,
#' `prob_metric_summarizer()` `dynamic_survival_metric_summarizer()`, or
