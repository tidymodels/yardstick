...
# get_metrics() errors on incompatible metric types
    ...
    Condition
      ...
      * a mix of dynamic and static survival metrics.
      ...
      - class (accuracy, bal_accuracy, detection_prevalence, f_meas, fall_out, j_index, kap, markedness, mcc, miss_rate, npv, ppv, precision, recall, roc_dist, sedi, sens, sensitivity, spec, specificity)
