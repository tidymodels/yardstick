...
For instance,
[`rmse()`](https://yardstick.tidymodels.org/reference/rmse.md) can be
used with [`mae()`](https://yardstick.tidymodels.org/reference/mae.md)
because they are numeric metrics, but not with
