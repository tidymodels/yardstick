...
[integrated-survival-metrics](https://yardstick.tidymodels.org/reference/integrated-survival-metrics.md)
for integrated survival metrics

[static-survival-metrics](https://yardstick.tidymodels.org/reference/static-survival-metrics.md)
for static survival metrics

[linear-pred-survival-metrics](https://yardstick.tidymodels.org/reference/linear-pred-survival-metrics.md)
