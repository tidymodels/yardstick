...
[`sens()`](https://yardstick.tidymodels.org/reference/sens.md) or
[`spec()`](https://yardstick.tidymodels.org/reference/spec.md) between
groups is the return value of `equalized_odds()`'s `.estimate`.
...
of [`sens()`](https://yardstick.tidymodels.org/reference/sens.md) and
[`spec()`](https://yardstick.tidymodels.org/reference/spec.md) metric
values by group before summarizing across groups using the
...
output with
[`sens()`](https://yardstick.tidymodels.org/reference/sens.md) and
[`spec()`](https://yardstick.tidymodels.org/reference/spec.md) values
