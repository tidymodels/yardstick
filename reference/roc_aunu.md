...
curve of each class against the rest, using the uniform class
distribution. This is equivalent to `roc_auc(estimator = "macro")`.
...
the uniform class distribution and is equivalent to
...
rest, using the a priori class distribution.
